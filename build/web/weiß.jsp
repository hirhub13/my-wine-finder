                    ...
                    <div class="middle">
                        <div class="search">
                            <div class="search-text"> 
                                <input type="text" style="color:white; width:100% " name="search" placeholder="Weißweine suchen ..." value="<%= request.getParameter("search") == null ? "" : request.getAttribute("search")%>">
                            </div>
                        </div>
                    </div>
                                ...
                                <table border="0" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:22%; text-align: center; font-size: 1.8vw;">Weinname</th>
                                            <th style="width:15%; text-align: center; font-size: 1.8vw;">Weingut</th>
                                            <th style="width:15%; text-align: center; font-size: 1.8vw;">Jahrgang</th>
                                            <th style="width:10%; text-align: center; font-size: 1.8vw;">Preis</th>
                                            <th style="width:15; text-align: center; font-size: 1.8vw;">Link</th>
                                            <th style="width:13%; text-align: center; font-size: 1.8vw;">vol.</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%
                                            ...
                                            if (filterwein == null) {
                                                ...
                                                for (Wine we : weine) {
                                                    ...
                                                    out.println("<td class='sale-desc' sytle='color: black; text-align: left;'><a class='wein' style=' font-size:1.1vw; ' href='beschreibung.jsp?weinid=" + we.getWeinid() + "' name='click'>" + we.getWeinname() + "</td>");
                                                    out.println("<td class='sale-desc' sytle='color: black; text-align: left;'><p style=' color:white; font-size:1.1vw; vertical-align: middle;'>" + String.format("%s", we.getWeingut()) + "</p>" + "</td>");
                                                    out.println("<td class='sale-desc' sytle='color: black; text-align: center;'><p style=' color:white; font-size:1.1vw; vertical-align: middle;'>" + String.format("%d", we.getJahrgang()) + "</p>" + "</td>");
                                                    out.println("<td class='sale-desc' sytle='color: black; text-align: center;'><p style=' color:white; font-size:1.1vw; vertical-align: middle;'> " + String.format("%1.2f", we.getPreis()) + "€</p>" + "</td>");
                                                    out.println("<td class='sale-desc' sytle='color: black; text-align: left;'><a class='wein' style='text-decoration: underline; font-size:1.1vw; vertical-align: middle;' href=" + String.format("%s", we.getWeinlink()) + " target='_blank'>Website</td>");
                                                    //out.println("<td class='sale-desc' sytle='color: black' style='text-align: center'; width = '10%'>  <a href = '" + we.getWeinlink() + "'>Website</a></td>");
                                                    out.println("<td class='sale-desc' sytle='color: black; text-align: center;'><p style=' color:white; font-size:1.1vw; vertical-align: middle;'> " + String.format("%1.2f", we.getAlkoholgehalt()) + "%</p>" + " </td></tr>");
                                                }
