        ...
        <header id="header">
            <div class="inner">
                ...
                <nav id="nav">
                    ...
                    <a href="AlleWeineServlet">Weißweine</a>
                    ...
                    <div class="middle">
                        <div class="search">
                            <div class="search-text"> 
                                <input type="text" style="color:white; width:100% " name="search" placeholder="Weine suchen ..." value="<%= request.getParameter("search") == null ? "" : request.getAttribute("search")%>">
                            </div>
                        </div>
                    </div>
