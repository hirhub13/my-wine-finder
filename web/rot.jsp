    ...
    <body>
        ...
        <section id="banner">
            <div class="inner">
                ...
                <form method="post" action="RotServlet">
                    <div class="middle">
                        <div class="search">
                            <div class="search-text"> 
                                <input type="text" style="color:white; width:100% " name="search" placeholder="Rotweine suchen ..." value="<%= request.getParameter("search") == null ? "" : request.getAttribute("search")%>">
                            </div>
                        </div>
                    </div>
                                        ...
                                        <%
                                            ...
                                            if (filterwein == null) {
                                                ...
                                                for (Wine we : weine) {
                                                    ...
                                                    out.println("<td class='sale-desc' sytle='color: black; text-align: left;'><a class='wein' href='beschreibung.jsp?weinid=" + we.getWeinid() + "' name='click'>" + we.getWeinname() + "</td>");
