 ...
 * @author hirhu
 */
@WebServlet(name = "WeißServlet", urlPatterns = {"/WeißServlet"})
public class WeißServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            weine = (LinkedList<Wine>) dba.getWeißweine();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher rd = request.getRequestDispatcher("weiß.jsp");
...
//        System.out.println(click+"hugo idt daaaaaaa");
//        if (click != null) {
