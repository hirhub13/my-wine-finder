 ...
 * @author hirhu
 */
@WebServlet(name = "RotServlet", urlPatterns = {"/RotServlet"})
public class RotServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            weine = (LinkedList<Wine>) dba.getRotweine();
            weinfav = (LinkedList<Wine>) dba.getWeine();
            weine2 = (LinkedList<Wine>) dba.getRotweine();
            //this.getServletContext().setAttribute("liste", weine);
        } catch (Exception ex) {
            Logger.getLogger(RotServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher rd = request.getRequestDispatcher("rot.jsp");
