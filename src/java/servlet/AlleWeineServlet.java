 ...
 * @author hirhu
 */
@WebServlet(name = "AlleWeineServlet", urlPatterns = {"/AlleWeineServlet"})
public class AlleWeineServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            weine2 = (LinkedList<Wine>) dba.getWeine();
            //this.getServletContext().setAttribute("liste", weine);
        } catch (Exception ex) {
            Logger.getLogger(AlleWeineServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("alleweine.jsp");
